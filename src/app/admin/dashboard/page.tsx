  ...
  return (
    <div className="h-full overflow-auto bg-gradient-to-br from-white to-[rgb(18,51,119)]/10 p-4 sm:p-6 lg:p-8">
      <div className="mb-8 flex flex-col items-start justify-between gap-4 sm:flex-row">
        ...
        <div className="flex w-full items-center gap-3 rounded-lg border border-[rgb(18,51,119)]/20 bg-white px-4 py-2 sm:w-auto">
              ...
              >
                ...
                <div className="flex w-full gap-2 md:w-auto">
                  <button
                    ...
                    className="flex-1 rounded bg-[rgb(249,153,28)] px-3 py-2 text-sm font-medium text-white hover:bg-[rgb(249,153,28)]/90 md:flex-none"
                  ...
                  <button
                    ...
                    className="flex-1 rounded border border-[rgb(18,51,119)] bg-white px-3 py-2 text-sm font-medium text-[rgb(18,51,119)] hover:bg-[rgb(18,51,119)] hover:text-white md:flex-none"
                    disabled={confirmMutation.isPending}
                  >
                    Refuser
                  </button>
  ...
  return (
    <div className="h-full overflow-auto bg-gradient-to-br from-white to-[rgb(18,51,119)]/10 p-4 sm:p-6 lg:p-8">
      <div className="mb-8">
        ...
        <div className="h-5 w-full max-w-96 animate-pulse rounded-lg bg-[rgb(18,51,119)]/20" />
      </div>
